  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex justify-end pb-8">
        <button className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors shadow-sm">
