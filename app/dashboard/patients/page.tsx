      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-t border-gray-200 bg-gray-50/50">
          ...
          <div className="flex items-center gap-1">
            ...
            <button className="px-3 py-1.5 rounded-lg bg-emerald-600 text-white text-sm font-medium">
              1
            </button>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <button
                  onClick={() => setShowAddModal(false)}
                  className="flex-1 px-4 py-2.5 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-700 transition-colors shadow-sm"
                >
                  Add Patient
                </button>
              </div>
